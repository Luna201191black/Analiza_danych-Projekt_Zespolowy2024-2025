...
![Porównanie wnioskowanej kwoty w zależności od stanu umowu](Test_Statystyczny_1.png)
Na podstawie wykresu i wyników testów statystycznych z użyciem funkcji ggbetweenstats, można wyciągnąć następujące wnioski:
1. *Istotność różnic między grupami*:  
...
![Korelacja między wnioskowaną kwotą a kwotą kredytu](Test_Statystyczny_2.png)
